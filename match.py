...
mask_paths = ['mask_channel_0.png', 'mask_channel_1.png', 'mask_channel_2.png']
...
directory_path = '/home/iai-lab/Documents/YCB_Video_Dataset/viewpoints_42/008_pudding_box'
image_files = [os.path.join(directory_path, file) for file in os.listdir(directory_path) if file.endswith('color.png')]
...
means = [tensor.mean().item() for tensor in cosine_similarities]
